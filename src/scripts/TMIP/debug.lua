        ...
        if x and z and type(x) == 'number' and type(z) == 'number' then
            SendCommand(
                string.format(
                    ...
                    '0, ' ..
                    z ..
                    ') else player.Transform:SetPosition(' ..
                    x .. ', ' .. '0, ' .. z .. ') end end',
                    GetCharacter()
        )
        )
...
local function DayAndTimeList()
    ...
    for _, v in pairs(daysarray) do
        dayandtimelist[index] = {
            ...
            tip = STRINGS.TOO_MANY_ITEMS_UI.DEBUG_TIME_SKIPDAYTIP ..
            ' ' ..
            v ..
            ' ' ..
            (v == 1 and STRINGS.UI.PLAYERSTATUSSCREEN.AGE_DAY or STRINGS.UI.PLAYERSTATUSSCREEN.AGE_DAYS),
            fn = {
                'confirm',
                'c_skip(' .. v .. ')',
                STRINGS.TOO_MANY_ITEMS_UI.DEBUG_TIME_SKIPDAYSCONFIRM,
                string.format(STRINGS.TOO_MANY_ITEMS_UI.DEBUG_TIME_SKIPDAYSCONFIRMTIP, v)
            }
        }
        index = index + 1
    end
    ...
    for _, n in pairs(timearray) do
        dayandtimelist[index] = {
            ...
            fn = {
                'confirm',
                'TheSim:SetTimeScale(' .. n .. ') print("Speed is now ", TheSim:GetTimeScale())',
                STRINGS.TOO_MANY_ITEMS_UI.DEBUG_TIME_SPEEDRUNCONFIRM,
                string.format(STRINGS.TOO_MANY_ITEMS_UI.DEBUG_TIME_SPEEDRUNCONFIRMTIP, n * 100) .. '% ?'
            }
        }
        index = index + 1
    end
...
return {
    ...
    {tittle = STRINGS.TOO_MANY_ITEMS_UI.DEBUG_TIME_TEXT, list = DayAndTimeList()},
    {
        ...
        list = {
            {
                ...
                fn = {
                    ...
                    STRINGS.TOO_MANY_ITEMS_UI.TMIP_CONSOLE .. '"',
            ...
            },
            {
                ...
                fn = {
                    ...
                    '").components.talker:Say("' ..
                    STRINGS.TOO_MANY_ITEMS_UI.PLAYER_NOT_ON_SLAVE_TIP ..
                    '") end player:PushEvent("respawnfromghost") player.rezsource = "' ..
                    STRINGS.TOO_MANY_ITEMS_UI.TMIP_CONSOLE .. '"',
            ...
            },
            {
                ...
                fn = {
                    'confirm',
                    'c_despawn(%s)',
                    STRINGS.TOO_MANY_ITEMS_UI.DEBUG_CHARACTER_DESPAWN,
    ...
    },
    {
        ...
        list = {
            ...
            },
            {
                ...
                fn = 'local a=%s;if a==nil then UserToPlayer("' ..
                _G.TOOMANYITEMS.DATA.ThePlayerUserId ..
                '").components.talker:Say("' ..
                STRINGS.TOO_MANY_ITEMS_UI.PLAYER_NOT_ON_SLAVE_TIP ..
        ...
        list = {
            {
                ...
                fn = {
                    'confirm',
                    'c_reset()',
                    STRINGS.TOO_MANY_ITEMS_UI.DEBUG_SERVER_RESET,
            ...
            },
            {
                ...
                fn = {
                    'confirm',
                    'c_regenerateworld()',
                    STRINGS.TOO_MANY_ITEMS_UI.DEBUG_SERVER_REGENERATE,
            ...
            },
            {
                ...
                fn = {
                    'confirm',
                    'if TheNet:GetIsServer() and TheNet:GetServerIsDedicated() then c_shutdown(true) end',
                    STRINGS.TOO_MANY_ITEMS_UI.DEBUG_SERVER_SHUTDOWN,
    ...
    },
    {
        ...
        list = {
            ...
            },
            {
                ...
                tip = STRINGS.TOO_MANY_ITEMS_UI.DEBUG_EVENT_TIPTEXT ..
        ...
        list = {
            {
                ...
                fn = {
                    'confirm',
                    'c_rollback(1)',
                    STRINGS.UI.BUILTINCOMMANDS.ROLLBACK.PRETTYNAME,
    ...
    {tittle = STRINGS.TOO_MANY_ITEMS_UI.DEBUG_TELEPORT_SAVE_TEXT, list = GetTeleportList(TeleportFnc)},
    {
